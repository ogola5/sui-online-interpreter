...
function hint(e) {
  return text([ cmd(Ee.Style, be.BrightBlack), `${xe.BottomLeft} `, cmd(Ee.Style, be.BrightBlue), `${Ae.Info} `, cmd(Ee.Style, be.Blue), indent(e, "    ") ]);
}
...
var documentSummary$1 = e => {
  ...
  if ("number" != typeof e ? Object.values(e).every((e => !e)) : !e) {
    ...
    for (var r in e) {
      t += text([ cmd(Ee.Style, be.BrightBlack), `${xe.BottomLeft} `, cmd(Ee.Style, be.BrightBlue), `${e[r]} documents extracted for the '${r}' schema\n` ]);
    }
  }
  return t;
};
...
function runningPersisted(e, t) {
  var r = e ? t ? `(${e}/${t})` : `(${e})` : "";
  return pipe(interval(150), map((e => text([ cmd(Ee.Style, be.Magenta), Oe[e % Oe.length], " ", cmd(Ee.Style, be.Foreground), `Scanning files${$e.Ellipsis} `, cmd(Ee.Style, be.BrightBlack), r ]))));
}
      ...
      if ("EXTERNAL_WARNING" === p.kind) {
        ...
        if (p.warnings.length) {
          ...
          for (var g of p.warnings) {
            m += (E = g, text([ Ne, cmd(Ee.Style, be.BrightBlack), `${E.line}:${E.col}`, $e.Tab, cmd(Ee.Style, be.Foreground), indent(E.message.trim(), text([ Ne, $e.Tab ])), $e.Newline ]));
            warningGithub$1(g);
          }
          yield m + "\n";
        }
...
var documentSummary = e => {
  ...
  if ("number" == typeof e) {
    ...
    for (var r in e) {
      t += text([ cmd(Ee.Style, be.BrightBlack), `${xe.BottomLeft} `, cmd(Ee.Style, be.BrightBlue), `${e[r]} document types cached for the '${r}' schema\n` ]);
    }
  }
  return t;
};
    ...
    for await (var p of c) {
      if ("EXTERNAL_WARNING" === p.kind) {
        ...
        if (p.warnings.length) {
          ...
          for (var g of p.warnings) {
            m += (E = g, text([ Ue, cmd(Ee.Style, be.BrightBlack), `${E.line}:${E.col}`, $e.Tab, cmd(Ee.Style, be.Foreground), indent(E.message.trim(), text([ Ue, $e.Tab ])), $e.Newline ]));
            warningGithub(g);
          }
          yield m + "\n";
        }
...
function diagnosticMessage(e) {
  ...
  return text([ Ve, cmd(Ee.Style, be.BrightBlack), `${e.line}:${e.col}`, $e.Tab, cmd(Ee.Style, t), e.severity, $e.Tab, cmd(Ee.Style, be.Foreground), indent(e.message.trim(), text([ Ve, $e.Tab, $e.Tab ])), $e.Newline ]);
}
...
function runningDiagnostics(e, t) {
  var r = e ? t ? `(${e}/${t})` : `(${e})` : "";
  return pipe(interval(150), map((e => text([ cmd(Ee.Style, be.Magenta), Oe[e % Oe.length], " ", cmd(Ee.Style, be.Foreground), `Checking files${$e.Ellipsis} `, cmd(Ee.Style, be.BrightBlack), r ]))));
}
...
function emptyLine() {
  return text([ cmd(Ee.Style, be.BrightBlack), xe.Vertical, "\n" ]);
}

function completedTask(e, t = !1) {
  return text([ emptyLine(), cmd(Ee.Style, be.BrightBlack), t ? xe.BottomLeft : xe.VerticalRight, " ", cmd(Ee.Style, be.Green), Ae.TickSwoosh, " ", cmd(Ee.Style, be.Foreground), e, "\n" ]);
}

function failedTask(e) {
  return text([ emptyLine(), cmd(Ee.Style, be.BrightBlack), xe.BottomLeft, " ", cmd(Ee.Style, be.BrightRed), Ae.CrossSwoosh, " ", cmd(Ee.Style, be.Foreground), e, "\n" ]);
}

function warningTask(e) {
  return text([ emptyLine(), cmd(Ee.Style, be.BrightBlack), xe.VerticalRight, " ", cmd(Ee.Style, be.BrightYellow), Ae.Warning, " ", cmd(Ee.Style, be.Foreground), e, "\n" ]);
}

function hintMessage(e) {
  return text([ cmd(Ee.Style, be.BrightBlack), `${xe.VerticalRight} `, cmd(Ee.Style, be.BrightBlue), `${Ae.Info} `, cmd(Ee.Style, be.Blue), indent(e, text([ cmd(Ee.Style, be.BrightBlack), `${xe.Vertical}   `, cmd(Ee.Style, be.Blue) ])) ]);
}
...
async function* run$1() {
  yield function title(e, t) {
    var r = text([ cmd(Ee.Style, be.BrightBlack), xe.TopLeft, " ", cmd(Ee.Style, [ be.Magenta, be.Invert ]), ` ${e.trim()} `, cmd(Ee.Style, [ be.NoInvert ]), "\n" ]);
    if (t) {
      r += text([ cmd(Ee.Style, be.BrightBlack), xe.Vertical, ` ${t}\n` ]);
    }
    return r;
  ...
  yield function success() {
    return text([ "\n", cmd(Ee.Style, [ be.Green, be.Invert ]), " Done ", cmd(Ee.Style, be.NoInvert), $e.Space, "You are all set and ready to go.\n" ]);
  }();
}
...
}(), o = (e, t) => gt ? e : t, Ct = o("◆", "*"), Et = o("■", "x"), Ft = o("▲", "x"), yt = o("◇", "o"), wt = o("┌", "T"), bt = o("│", "|"), Bt = o("└", "—"), St = o("●", ">"), $t = o("○", " "), y = e => {
  switch (e) {
   case "initial":
   case "active":
    return nt.cyan(Ct);
  ...
  return new xD({
    ...
    render() {
      ...
      switch (this.state) {
       ...
       default:
        return `${n}${nt.cyan(bt)}  ${this.value ? `${nt.green(St)} ${t}` : `${nt.dim($t)} ${nt.dim(t)}`} ${nt.dim("/")} ${this.value ? `${nt.dim($t)} ${nt.dim(r)}` : `${nt.green(St)} ${r}`}\n${nt.cyan(Bt)}\n`;
      }
    }
  }).prompt();
}, ue = (e = "") => {
...
xt.exports._parse = ar;

xt.exports._enoent = ur;
